...
suit.addTest(loder.loadTestsFromModule(class_unittest))

with open('ces.html', 'wb') as file:
    runner = HTMLTestRunner.HTMLTestRunner(stream=file, verbosity=2, title='zongshuren', description='nihao')
    runner.run(suit)